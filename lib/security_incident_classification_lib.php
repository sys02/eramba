...
function list_drop_menu_security_incident_classification($pre_selected_items='', $order_clause='') {
	...
	# MUST EDIT
	$sql = "SELECT * FROM security_incident_classification_tbl WHERE security_incident_classification_disabled = \"0\"".$order_clause."";
	$results = runQuery($sql);
...
function export_security_incident_classification_csv() {
	...
	fwrite($handler, "security_incident_classification_id,security_incident_classification_name,security_incident_classification_description,security_incident_classification_disabled\n");
	foreach($result as $line) {
		fwrite($handler,"$line[security_incident_classification_id],$line[security_incident_classification_name],$line[security_incident_classification_criteria],$line[security_incident_classification_disabled]\n");
	}
