...
$system_records_list = list_system_records(" WHERE system_records_section = \"risk\" AND system_records_subsection = \"risk_management_edit\" AND system_records_item_id =\"$risk_data[risk_id]\" ORDER by system_records_date LIMIT 5");
